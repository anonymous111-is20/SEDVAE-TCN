...
class DVAE2(nn.Module):
    ...
    def loss_function(self, recon_x, x, mu, logsig, source_length):
    ...
    def decoder_init(self):
        ...
        self.dec_upconv5 = nn.ConvTranspose1d(in_channels=4, out_channels=8, stride=2, kernel_size=3, output_padding=1, padding=1)
        ...
        self.dec_upconv4 = nn.ConvTranspose1d(in_channels=8, out_channels=16, stride=2, kernel_size=3, output_padding=1, padding=1)
        ...
        self.dec_upconv3 = nn.ConvTranspose1d(in_channels=16, out_channels=32, stride=2, kernel_size=3, output_padding=1, padding=1)
        ...
        self.dec_upconv2 = nn.ConvTranspose1d(in_channels=32, out_channels=64, stride=2, kernel_size=3, output_padding=1, padding=1)
        ...
        self.dec_upconv1 = nn.ConvTranspose1d(in_channels=64, out_channels=1, stride=2, kernel_size=3, output_padding=1, padding=1)
    ...
    def forward(self, x, test=False):
        ...
        enc_filter1 = self.enc_filter1(enc_tcn1)
        ...
        enc_filter2 = self.enc_filter2(enc_tcn2)
        ...
        enc_filter3 = self.enc_filter3(enc_tcn3)
        ...
        enc_filter4 = self.enc_filter4(enc_tcn4)
        ...
        enc_filter5 = self.enc_filter5(enc_tcn5)
        ...
        input_dec_upconv3 = torch.mul(dec_prelu4, enc_filter3)
        ...
        input_dec_upconv2 = torch.mul(dec_prelu3, enc_filter2)
        ...
        input_dec_upconv1 = torch.mul(dec_prelu2, enc_filter1)
